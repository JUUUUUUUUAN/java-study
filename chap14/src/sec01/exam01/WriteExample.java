...
public class WriteExample {
	...
	public static void main(String[] args) throws Exception {
		// 데이터 도착지를 test1.db 파일로 하는 바이트 기반 출력 스트림을 생성
...
//		byte c = 30;
		...
		char c = '다';
		// 해결 방법 2가지
		// 1. 문자 기반 FileWriter 사용(OutputStreamWriter 사용)
		...
		os.write(b);
		os.write(c);
		// write()를 한다고 해서 바로 출력 스트링을 통해 데이터가 흘러가는 것이 아님
		// 버퍼(임시 저장 공간)에 쌓임
		// 버퍼: 물건을 잠시 담아두는 창고
		...
		os.close(); // 출력 스트림이 사용했던 자원들(메모리)를 풀어주기 위해
		// 참고: close() 안에서도 스트림을 닫기 전에 flash() 기능을 수행함
