...
//	- 축구공: 3000원
	public static void main(String[] args) {
		...
		Set<Equipment> a = new HashSet<Equipment>();
		a.addAll(storage1);
		a.addAll(storage2);
		System.out.println("*** 합집합 ***");
		Iterator<Equipment> aI = a.iterator();
		while(aI.hasNext()) {
			System.out.println("-" + aI.next());
		}
		
		Set<Equipment> b = new HashSet<Equipment>();
		b.addAll(storage1);
		b.retainAll(storage2);
		System.out.println("*** 교집합 ***");
		Iterator<Equipment> bI = b.iterator();
		while(bI.hasNext()) {
			System.out.println("-" + bI.next());
		}
		
		Set<Equipment> c = new HashSet<Equipment>();
		c.addAll(storage1);
		c.removeAll(storage2);
		System.out.println("*** 차집합 ***");
		Iterator<Equipment> cI = c.iterator();
		while(cI.hasNext()) {
