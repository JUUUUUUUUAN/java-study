	...
	int num = 0;
		...
		public void memberMenu() {
			...
			while(true) {
				...
				if (num == 1) changePassword();
				else if (num == 2) changeName();
				else if (num == 3) System.out.println("로그아웃 되었습니다."); return;
		...
		public void joinMember() {
			...
			boolean result = mc.joinMember(id, new Member(name, pw));
		...
		public void changePassword() {
			...
			result = mc.changePassword(id, pw, newPw);
