...
public class BookMenu {
    ...
    public void mainMenu(){
      ...
      // 만일 1,2,3,4,5,9 외의 숫자 입력하면 -> "잘못 입력하였습니다. 다시 입력해주세요." 출력
		...
		sc.nextLine();
			...
			else if(num != 9) System.out.println("잘못 입력하였습니다. 다시 입력해주세요.");
    ...
    public void insertBook(){
    	...
    	String category1 = "";
    	if (category == 1) category1 = "인문";
    	else if (category == 2) category1 = "자연과학";
    	else if (category == 3) category1 = "어린이";
    	else category1 = "기타";
    	b = new Book(title, author, category1, price);
