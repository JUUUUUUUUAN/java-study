...
public class CalendarExample {
	...
	public static void main(String[] args) {
		...
		LocalDateTime deadline = LocalDateTime.of(2025, 8, 4, 12, 0); // 2025년 8월 4일 오후 6시
		...
		String today1 = sdf4.format(now3);
		System.out.println(today1);
		
		Calendar cal1 = Calendar.getInstance();
		int year3 = cal1.get(Calendar.YEAR);
		int month3 = cal1.get(Calendar.MONTH) + 1;
		String month4 = month3 < 10 ? "0"+month3 : ""+month3;
		int day3 = cal1.get(Calendar.DAY_OF_MONTH);
//		int a = cal1.get(Calendar.DAY_OF_WEEK);
		// a는 strWeek으로 대체
		String day4 = day3 < 10 ? "0"+day3 : ""+day3;
		int hour3 = cal1.get(Calendar.HOUR);
		int minute3 = cal1.get(Calendar.MINUTE);
		
		System.out.println(year3 + "년 " + month4 + "월 " + day4 + "일 " + strWeek + "요일 " + hour3 + "시 " + minute3 + "분");
	}
